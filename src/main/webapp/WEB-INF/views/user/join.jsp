			...
			<div class="row">
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						...
						<form action="join">
							<input type="name" id="userId" name="userId" placeholder="id"/>
							<input type="password" id="userPassword" name="userPassword" placeholder="Password"/>
							<input type="password" id="userPasswordConfirm" placeholder="Password Confirm"/>
							<input type="text" id="userName" name="userName" placeholder="Name"/>
							<input type="text" id="userTel" name="userTel" placeholder="Tel"/>
							...
							<button type="button" id="btnJoin" class="btn btn-default">Signup</button>
						</form>
					</div><!--/sign up form-->
				</div>
			</div>
